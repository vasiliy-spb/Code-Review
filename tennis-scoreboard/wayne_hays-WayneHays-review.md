...
- если создать игрока с максимально длинным именем, то колонки очков сдвинутся вбок ![](images/wayne_hays-WayneHays/Screenshot_01.png)
- если создать двух игроков с максимально длинными именами, при этом у одного сделать имя сплошной строкой, а у другого все части имени писать через пробел (для возможности переноса в любом месте), то (помимо съехавших колонок с очками) кнопки будут разного размера ![](images/wayne_hays-WayneHays/Screenshot_02.png)
...
- исключение из метода `next()` нигде не обрабатывается по стеку вызовов и если оно происходит, пользователь видит страницу 500-ой ошибки ![](images/wayne_hays-WayneHays/Screenshot_03.png)
